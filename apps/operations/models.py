...
class DeliveryMovement(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["movement_date", "driver"]),
            models.Index(fields=["movement_date", "client"]),
        ]
...
class DeliveryOccurrence(models.Model):
    ...
    class Meta:
        indexes = [
            ...
            models.Index(fields=["cte", "occurred_at"]),
            models.Index(fields=["movement", "occurred_at"]),
        ]
