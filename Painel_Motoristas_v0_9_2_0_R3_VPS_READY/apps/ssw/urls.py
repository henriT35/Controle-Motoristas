...
urlpatterns = [
    ...
    path("automacao/rotinas/salvar/", views.save_schedule_routine, name="ssw_schedule_routine_save"),
    path("automacao/rotinas/<str:routine_id>/excluir/", views.delete_schedule_routine, name="ssw_schedule_routine_delete"),
    path("automacao/rotinas/<str:routine_id>/executar/", views.trigger_schedule_routine, name="ssw_schedule_routine_run"),
