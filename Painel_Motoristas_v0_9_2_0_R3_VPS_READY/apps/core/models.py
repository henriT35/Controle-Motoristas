...
class SystemSettings(models.Model):
    ...
    # Ranking V3 oficial: uma única Nota Geral 0–100. Produtividade não entra
    # automaticamente na nota. Os três componentes são calibráveis.
    driver_v3_proofs_weight = models.DecimalField(max_digits=5, decimal_places=2, default=50)
    driver_v3_quality_weight = models.DecimalField(max_digits=5, decimal_places=2, default=35)
    driver_v3_regularity_weight = models.DecimalField(max_digits=5, decimal_places=2, default=15)
    driver_v3_exact_recovery_bonus = models.DecimalField(max_digits=5, decimal_places=2, default=0.30)
    driver_v3_gold_recovery_bonus = models.DecimalField(max_digits=5, decimal_places=2, default=0.90)
    driver_v3_bonus_cap = models.DecimalField(max_digits=5, decimal_places=2, default=5.00)
    driver_v3_exact_ignored_penalty = models.DecimalField(max_digits=5, decimal_places=2, default=0.00)
    driver_v3_regularity_window_days = models.PositiveSmallIntegerField(default=30)
    # Marco prospectivo: impede que obrigações de Regularidade da v0.9.2 penalizem histórico anterior ao rollout.
    driver_v3_actions_activation_date = models.DateField(null=True, blank=True)
    top1_reward_description = models.CharField(max_length=220, blank=True)
    top2_reward_description = models.CharField(max_length=220, blank=True)
    top3_reward_description = models.CharField(max_length=220, blank=True)
