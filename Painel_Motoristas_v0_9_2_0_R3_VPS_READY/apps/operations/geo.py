...
NEIGHBORHOOD_ALIASES = {
    ...
    ("PA", "MARITUBA", "ALMIR GRABRIEL"): "ALMIR GABRIEL",
    ("PA", "ANANINDEUA", "ALMIR GRABRIEL"): "ALMIR GABRIEL",
    ("PA", "BELEM", "PARK VERDE"): "PARQUE VERDE",
    ("PA", "ANANINDEUA", "PARK VERDE"): "PARQUE VERDE",
}
...
def cached_geo_summary(*args, **kwargs):
    ...
    key = versioned_key("geo-v3", branch, start, end, metric, level, parent_state, parent_city, driver_id or "all")
